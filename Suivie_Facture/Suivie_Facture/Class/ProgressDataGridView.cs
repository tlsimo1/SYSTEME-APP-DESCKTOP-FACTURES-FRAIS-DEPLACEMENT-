...
{
    internal class ProgressDataGridView : DataGridView
    {
        ...
        public ProgressDataGridView()
        {
            ...
            AnimationThread.DoWork += AnimationThread_DoWork2;
            DataThread.DoWork += DataThread_DoWork2;
            DataThread.RunWorkerCompleted += DataThread_RunWorkerCompleted2;
        ...
        private void DataThread_DoWork(object sender, DoWorkEventArgs e)
        {
           ...
           // string commandText = (string)arguments[1];
            ...
            Datatable = facture_BL.GetAllFacture();
            //        //load to dataset
        ...
        private void DataThread_RunWorkerCompleted2(object sender, RunWorkerCompletedEventArgs e)
        {
            //once the data is loaded, stop the loading cursor and repaint the datagrid
            ShowLoadingCursor = false;
            Invalidate();
        ...
        private void DataThread_DoWork2(object sender, DoWorkEventArgs e)
        {
            Facture_BL facture_BL = new Facture_BL();
            // object[] arguments = (object[])e.Argument;
            // string connectionString = (string)arguments[0];
        ...
        private void AnimationThread_DoWork2(object sender, DoWorkEventArgs e)
        {
        ...
        public void LoadData(string connectionString, bool autoGenerateColumns)
        {
            ...
            //load the data
            object[] arguments = new object[] { connectionString, autoGenerateColumns };
